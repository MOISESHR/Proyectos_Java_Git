...
import pe.com.claro.eba.activospostpagoejbs.service.GestionActualizaEstadosService;
...
public class GestionActualizaEstadosMDBBean implements MessageListener {
    
    private static Logger logger = Logger.getLogger(GestionActualizaEstadosMDBBean.class);
    
    @Resource
    private MessageDrivenContext context;
    
    @Autowired
    private GestionActualizaEstadosService gestionActualizaEstadosService;
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            gestionActualizaEstadosService.procesarActualizacionesEstado(msg);
