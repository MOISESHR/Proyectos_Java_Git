 ...
 *         &lt;element name="transferencia" type="{http://claro.com.pe/eai/ebs/ws/ActivosPostpagoEJB}TransferirContratoType"/>
...
@XmlType(name = "",
         propOrder = { "idTransaccion", "nombreAplicacion", "ipAplicacion",
                       "usuarioAplicacion", "transferencia", "servicios" })
@XmlRootElement(name = "TransferirContratoRequest")
public class TransferirContratoRequest implements java.io.Serializable {
    ...
    @XmlElement(required = true)
    protected TransferirContratoType transferencia;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link TransferirContratoType }
     *
     */
    public TransferirContratoType getTransferencia() {
     ...
     *
     */
    public void setTransferencia(TransferirContratoType value) {
