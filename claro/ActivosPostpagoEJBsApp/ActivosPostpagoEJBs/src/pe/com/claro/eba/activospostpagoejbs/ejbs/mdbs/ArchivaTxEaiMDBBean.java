...
import pe.com.claro.eba.activospostpagoejbs.service.GestionTxEaiService;
...
public class ArchivaTxEaiMDBBean implements MessageListener {
    
    private static Logger logger = Logger.getLogger(ArchivaTxEaiMDBBean.class);
  
    @Resource
    private MessageDrivenContext context;
  
    @Autowired
    private GestionTxEaiService gestionTxEaiService;
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            gestionTxEaiService.procesarArchivamientoTxEAI(msg);
