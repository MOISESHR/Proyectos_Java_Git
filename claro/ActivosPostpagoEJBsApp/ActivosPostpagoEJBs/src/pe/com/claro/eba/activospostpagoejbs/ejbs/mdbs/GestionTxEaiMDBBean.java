...
public class GestionTxEaiMDBBean implements MessageListener {

    private static Logger logger = Logger.getLogger(GestionTxEaiMDBBean.class);
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            gestionTxEaiService.procesarTransaccionesEAI(msg);
